...
public class MalformedTokenException extends RuntimeException {
    @Serial
    private static final long serialVersionUID = 2285807788966028365L;
     ...
     */
    public MalformedTokenException(String message, HttpServletRequest httpServletRequest) {
        super(message);
     ...
     * @since 1.4
     */
    public MalformedTokenException(String message, Throwable cause, HttpServletRequest httpServletRequest) {
        super(message, cause);
        this.httpServletRequest = httpServletRequest;
    }
