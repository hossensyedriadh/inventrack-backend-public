...
public class MalformedTokenException extends RuntimeException {
    @Serial
    private static final long serialVersionUID = -7730266805105563411L;
     ...
     */
    public MalformedTokenException(String message, String path) {
        super(message);
        this.path = path;
    }
     ...
     * @since 1.4
     */
    public MalformedTokenException(String message, Throwable cause, String path) {
        super(message, cause);
        this.path = path;
    }
