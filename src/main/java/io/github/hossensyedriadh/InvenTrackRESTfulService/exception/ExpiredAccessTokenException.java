...
public class ExpiredAccessTokenException extends RuntimeException {
    @Serial
    private static final long serialVersionUID = 6464696525162399720L;
     ...
     */
    public ExpiredAccessTokenException(String message, String path) {
        super(message);
        this.path = path;
    }
     ...
     * @since 1.4
     */
    public ExpiredAccessTokenException(String message, Throwable cause, String path) {
        super(message, cause);
        this.path = path;
    }
